...
namespace EcommerceProject.Controllers
{
    public class SpecialTagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TagName")] SpecialTag specialTag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TagName")] SpecialTag specialTag)
        {
            if (id != specialTag.Id)
            {
                return NotFound();
